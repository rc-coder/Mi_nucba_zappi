...
//Para hacer un input mas estilizado, se hace al input transparente y se estiliza al contenedor
...
export const Input = (props) => {
  ...
  /* console.log('TOUCH', inputState.isTouch);
  console.log('Valid', inputState.isValid);
  console.log('FINAL', !inputState.isValid && inputState.isTouch); */
